...
Connects to Snowflake using SnowparkSession

Uploads CSV to stage (e.g., @raw_stage)

Infers schema from CSV header

Creates Bronze table automatically (if not exists)
