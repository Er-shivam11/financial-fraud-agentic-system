...
TARGET_SCHEMA = "GOLD"  # ✅ Change to GOLD schema
...
# ✅ Point to models folder for gold layer
sql_files = sorted(glob.glob("./models/*.sql"))
...
if not sql_files:
    ...
    for sql_file in sql_files:
        ...
        try:
            ...
            # Split statements in case multiple queries in one file
